...
//                        qrImgImageView.setImageBitmap(qrCodeBitmap);
    ...
    private void save_pics(Bitmap bitmap) {
        String path = getApplicationContext().getFilesDir().getPath() + File.separator + "QRcode";
        ...
        try {
            ...
            fo.flush();
            fo.close();
            MediaStore.Images.Media.insertImage(getBaseContext().getContentResolver(), file.getAbsolutePath(), filename, null);
